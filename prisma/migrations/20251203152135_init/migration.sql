...
CREATE TABLE `Agency` (
    ...
    `agencyLogo` VARCHAR(191) NOT NULL,
...
CREATE TABLE `AgencySidebarOption` (
    ...
    `icon` ENUM('info', 'settings', 'users', 'tickets') NOT NULL DEFAULT 'info',
    `agencyId` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Subscription` (
    ...
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
    `plan` ENUM('price_FDFDFFDFFREFRERETTE', 'price_1FDVDVLKFGLDKGLDKFG') NULL,
