...
const LaunchpadPage: React.FC<LaunchpadPageProps> = async ({
  ...
  const stripeOAuthLink = `https://connect.stripe.com/oauth/authorize?response_type=code&client_id=${process.env.NEXT_PUBLIC_STRIPE_CLIENT_ID}&scope=read_write&redirect_uri=${redirectUri}&state=launchpad___${agencyDetails.id}`;
