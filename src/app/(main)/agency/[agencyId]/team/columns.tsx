...
import { deleteUser, getAuthUser, deleteInvitation } from "@/lib/queries";
  ...
  [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        // Use DiceBear if avatarUrl is missing
        const avatarSrc = avatarUrl || `https://api.dicebear.com/9.x/avataaars/svg?seed=${email}`;
    ...
    { accessorKey: "email", header: "Email" },
    {
      ...
      cell: ({ row }) => {
        ...
        const ownedAccounts = Array.isArray(permissions)
          ? permissions.filter((per) => per?.access)
          : [];
