...
const Home = ({ className = "" }: { className?: string }) => {
  return (
    <svg
      ...
      className={`text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-all duration-300 group-hover:scale-105 group-hover:-translate-y-0.5 ${className}`}
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
