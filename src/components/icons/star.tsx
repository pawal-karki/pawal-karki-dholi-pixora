...
const Star = ({ className = "" }: { className?: string }) => {
  return (
    <svg
      ...
      className={`text-slate-500 dark:text-slate-400 group-hover:text-amber-500 dark:group-hover:text-amber-400 transition-all duration-500 group-hover:scale-110 group-hover:rotate-12 group-hover:drop-shadow-lg ${className}`}
    >
      <path
