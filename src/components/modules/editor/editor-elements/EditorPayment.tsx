          ...
          <Badge
            ...
            onClick={async (e) => {
              ...
              const response = await createCheckoutPage(
                subAccountId,
                funnelId,
                "Product", // TODO: Get actual product name if possible
                JSON.stringify([
                  {
                    ...element,
                    id: crypto.randomUUID(), // New ID for the element on new page
                  }
                ])
              );
              ...
              if (response) {
                ...
                // Convert this element to a Link to the new page
                dispatch({
                  type: "UPDATE_ELEMENT",
                  payload: {
                    elementDetails: {
                      ...element,
                      type: "link", // Change type to link (requires changing Component type mostly)
                      content: {
                        innerText: "Buy Now",
